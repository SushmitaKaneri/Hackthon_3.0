...
constructor(props) {
  ...
  handleUpload = () => {
    ...
    if(this.state.reminderSet) data.append('reminder',JSON.stringify(this.state.reminder));
    else data.append('reminder',JSON.stringify(''));
    ...
    axios.post(server_url+'/api/upload/addnote', data,{
      ...
      .then(res => {
        alert("Note Added Successfully! You can check it in View.")
            ...
            <Col md="6">
              <Card className="mx-2">
                <CardBody className="p-5">
                  ...
                  <InputGroup className="mb-3">
                    <Input type="text" placeholder="Upto 1 label" id="label"/>
                  </InputGroup>	                      
                   <InputGroup className="mb-3">
